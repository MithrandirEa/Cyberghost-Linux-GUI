...
class TestGetCyberghostConfigDirDefault:
    def test_default_uses_home_env(self, tmp_path: Any) -> None:
    ...
    def test_default_ends_with_cyberghost(self, tmp_path: Any) -> None:
...
class TestGetCyberghostConfigDirFromFile:
    def test_reads_configured_path(self, tmp_path: Any) -> None:
    ...
    def test_falls_back_to_default_when_key_missing(self, tmp_path: Any) -> None:
...
class TestSetCyberghostConfigDir:
    def test_creates_settings_file(self, tmp_path: Any) -> None:
    ...
    def test_saves_configured_path(self, tmp_path: Any) -> None:
    ...
    def test_overrides_existing_value(self, tmp_path: Any) -> None:
